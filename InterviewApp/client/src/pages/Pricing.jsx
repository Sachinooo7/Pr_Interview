...
const Pricing = () => {
  ...
  const plans=[
    ...
    },
    {
      ...
      price:"Rs 100",
      credits:200,
      description:"Great for focus practce and skill improvement.",
      features:[
...
const handlePayment=async (plan)=>{
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-500 py-16 px-6'>
              ...
              <div className='mt-4'>
                ...
                <div className='mt-6 space-y-3 text-left'>
                 ...
                 {!plan.default 
                  && 
                 <button
                 disabled={loadingPlan===plan.id} onClick={(e)=>{e.stopPropagation();
                  if(!isSelected){
