...
const downloadPDF=()=>{
  ...
  currentY+=15;
            ...
            if(finalScore>=8){
              advice=
              "Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answer with strong real world example.";
            }
            else if(finalScore>=5){
              advice=
              "Good foundation shown . Improve clarity and structure."
            }
            else{
              advice="Significant improvement required . Focus on structured thinking,clarity and confident delivery."
    ...
    sm:px-6 lg:px-10 py-8  '>
      ...
      sm:justify-between gap-4'>
        ...
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
           ...
           <button onClick={downloadPDF} className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-3
