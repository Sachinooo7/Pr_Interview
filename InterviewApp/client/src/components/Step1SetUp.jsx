...
import {FaUserTie,
  FaBriefcase,
  FaFileUpload,FaMicrophoneAlt,FaChartLine
} from 'react-icons/fa'
       ...
       grid md:grid-cols-2 overflow-hidden'>
        ...
        p-12 flex flex-col justify-center'>
          ...
          <p className="text-gray-600 mb-10">
            Practical real interview scenerios powered by AI.
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              onChange={(e)=>setRole(e.target.value)} value={role}></input>
            </div>
            ...
            <div className='relative'>
              ...
              className='w-full pl-12 pr-4 py-3 border border-gray-200 
              rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
              onChange={(e)=>setExperience(e.target.value)} value={experience}></input>
            ...
            {!analysisDone &&(
              ...
              hover:border-green-500 hover:bg-green-50 transition'>
                <FaFileUpload className='mx-auto  text-green-600 text-4xl mb-3'/>

                <input type="file" accept="application/pdf"
                id="resumeUpload"
                className='hidden'
                onChange={(e)=>setResumeFile(e.target.files[0])}></input>
            ...
            {analysisDone && (
              ...
              className='bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4'>
                <h3 className='text-lg font-semibold text-gray-800'>
                  Resume Analysis Complete! We found 
                </h3>
                {projects.length >0 && (
                  <div>
            ...
            whileHover={{scale:1.03}}
            whileTap={{scale:0.95}}
            className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-600
