...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6 '>
        ...
        border border-gray-200 px-8 py-4 flex items-center justify-between relative'>
         ...
         <div className='flex items-center gap-6 relative'> 
            <div className='relative'>
                ...
                text-md text-md hover:bg-gray-200 transition'>
                ...
                { showCreditPopup && (
                    <div className='absolute -right-12.5 mt-3 w-64 bg-white shadow-xl
            ...
            <div className='relative'>
                ...
                setShowCreditPopup(false)
                }} className='flex items-center justify-center w-9 h-9 bg-black text-white
                ...
                { showUserPopup && (
                    ...
                    rounded-xl p-4 z-50'>
                        ...
                        <button onClick={handleLogout} className='w-full text-left text-sm py-2 flex items-center gap-2 text-red-500' >
                            <HiOutlineLogout size={16}></HiOutlineLogout>
                            Logout
                        </button>
                    </div>
                )}
