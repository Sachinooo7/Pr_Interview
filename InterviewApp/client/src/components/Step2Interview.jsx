...
// if (!interviewData) {
//   return <h2>No interview data found</h2>;
// }
...
// const { interviewId, questions } = interviewData;
  ...
  return (
    ...
    to-emerald-100 flex items-center justify-center p-4 sm:p-6'>
       ...
       p-6 space-y-6 border-r border-gray-200'>
        ...
        shadow-md p-6 space-y-5'>
          <div className='flex justify-between items-center'>
            ...
            <span className='text-sm font-semibold text-emerald-600'>{isAIPlaying?"AI Speaking":""}</span>
            }
          </div>
         ...
         {!isIntroPhase &&   <div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm'>
           ...
           {!feedback ?( 
             <div className='flex items-center gap-4 mt-6'>
              ...
              onClick={toggleMic}
              whileTap={{scale:0.9}}
              className='flex items-center w-12 h-12 sm:w-14 sm:h-14 justify-center rounded-full
              ...
              className='flex-1 bg-linear-to-r from-emerald-600 to-teal-500 text-white
              py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
                ...
                initial={{opacity:0}}
                animate={{opacity:1}}
                className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl 
                shadow-sm'>
